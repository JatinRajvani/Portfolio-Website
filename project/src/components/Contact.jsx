...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      'service_mdun3g9',  // Replace with your EmailJS Service ID
      'template_ybpwcql', // Replace with your EmailJS Template ID
      {
        from_name: formData.name,
        from_email: formData.email,
        message: formData.message,
      },
      'JCIfbMwc20QjIkcrL' // Replace with your EmailJS Public Key
    )
    .then(() => {
          ...
          <div className="text-center space-y-6">
            ...
            <div className="flex justify-center space-x-8">
              {[
                ...
                { icon: <Linkedin size={28} />, url: 'https://www.linkedin.com/in/jatin-rajvani/' },
                { icon: <Twitter size={28} />, url: 'https://twitter.com/yourusername' },
                { icon: <Globe size={28} />, url: 'https://portfolio-website-phi-virid.vercel.app/' }
              ].map((social, index) => (
                <motion.a
                  key={index}
                  whileHover={{ scale: 1.2, y: -5 }}
